<section id="main-form">
    ...
    {!! Form::hidden('id_catshopping', isset($thisdata->listRegister) ? $thisdata->listRegister[0]->id_catshopping : $thisdata->idfather, ['class' => 'form-control', 'readonly' => 'true']) !!}

    <ul id="main-form-list">
        <li class="size-col-2 size-content-1">
            {!! Form::label('name', 'Sub-Categoria*', array('class' => 'control-label' )) !!} 
