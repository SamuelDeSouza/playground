<section id="main-form">
     ...
     <ul id="main-form-list">
          ...
          <li class="size-col-5 size-content-2">
               {!! Form::label('name', 'Menu Visivel', array('class' => 'control-label' )) !!} 
               <div class="main-radio">
               {!!  Form::radio('visible', '1', isset($thisdata->listRegister) ? $thisdata->listRegister[0]->opcao1 : false, ['class' => 'form-control-radio', 'id' => 'radio1'])  !!} 
               ...
               <div class="main-radio">
               {!!  Form::radio('visible', '0', isset($thisdata->listRegister) ? $thisdata->listRegister[0]->opcao2 : false, ['class' => 'form-control-radio', 'id' => 'radio2'])  !!}
               @if(isset($thisdata->listRegister))
